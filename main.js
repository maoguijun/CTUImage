let postFile = {
    ...
    document.getElementById("cover_box").onmousemove =function(e){
      ...
      if(pageX > t.sx&& pageX <t.sx+t.sWidth && pageY > t.sy && pageY < t.sy + t.sHeight){
        ...
        // console.log("1");
          ...
          // var show_edit = document.getElementById("show_edit");
          //  show_edit.style.width = 2*t.sWidth+"px";
          //  show_edit.style.height = 2*t.sHeight+"px";
          //  show_edit.style.backgroundSize = "200% 200%";
        };
  ...
  // getFirstDot:function(e){
  //   this.sx = e.offsetX;
  //   this.sy = e.offsetY;

  // },
  // getSecondDot:function(e){
  //   this.sWidth = e.offsetX - this.sx;
  //   this.sHeight = e.offsetY - this.sy;
